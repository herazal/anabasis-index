---
title: "Programmation en C : Les boucles"
description: "Présentation des boucles `while`, `for` et `do…while`, contrôle de boucle (`break`, `continue`) et complexité temporelle."
tags:
  - c
  - programmation
  - boucles
...
[Regarder la vidéo sur YouTube](https://www.youtube.com/watch?v=sv3iWbmh3s8&list=PLYTHy808C4AAnAYPqZa_lPXDHUNaVTos1&index=10)

## Résumé technique

Présentation des boucles `while`, `for` et `do…while`, contrôle de boucle (`break`, `continue`) et complexité temporelle.
