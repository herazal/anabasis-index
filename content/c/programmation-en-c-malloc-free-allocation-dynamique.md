---
title: "Programmation en C : malloc(), free(), allocation dynamique"
description: "Gestion de la mémoire dynamique avec `malloc`, `calloc`, `realloc` et `free`, ainsi que détection de fuites mémoire."
tags:
  - c
  - programmation
  - dynamique
...
[Regarder la vidéo sur YouTube](https://www.youtube.com/watch?v=MVQPjDWc5qg&list=PLYTHy808C4AAnAYPqZa_lPXDHUNaVTos1&index=13)

## Résumé technique

Gestion de la mémoire dynamique avec `malloc`, `calloc`, `realloc` et `free`, ainsi que détection de fuites mémoire.
