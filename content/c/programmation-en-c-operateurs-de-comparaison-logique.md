---
title: "Programmation en C : Opérateurs de comparaison logique"
description: "Opérateurs de comparaison (`==`, `!=`, `<`, `>`, `<=`, `>=`) et opérateurs logiques (`&&`, `||`, `!`) avec tableaux de vérité."
tags:
  - c
  - programmation
  - logique
...
[Regarder la vidéo sur YouTube](https://www.youtube.com/watch?v=SxbYJmwAC5E&list=PLYTHy808C4AAnAYPqZa_lPXDHUNaVTos1&index=9)

## Résumé technique

Opérateurs de comparaison (`==`, `!=`, `<`, `>`, `<=`, `>=`) et opérateurs logiques (`&&`, `||`, `!`) avec tableaux de vérité.
