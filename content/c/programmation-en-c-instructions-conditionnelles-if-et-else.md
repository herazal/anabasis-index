---
title: "Programmation en C : Instructions conditionnelles : if et else"
description: "Usage des instructions conditionnelles `if` / `else`, exemples de flux d’exécution et bonnes pratiques de lisibilité."
tags:
  - c
  - programmation
  - else
...
[Regarder la vidéo sur YouTube](https://www.youtube.com/watch?v=uRqzRruK8vY&list=PLYTHy808C4AAnAYPqZa_lPXDHUNaVTos1&index=8)

## Résumé technique

Usage des instructions conditionnelles `if` / `else`, exemples de flux d’exécution et bonnes pratiques de lisibilité.
